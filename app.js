 ...
 */
const BUILD_VERSION = "dDAE_2.112";
...
// dDAE_2.112 — error overlay: evita blocchi silenziosi su iPhone PWA
...
if (page === "orepulizia") { initOrePuliziaPage().catch(e=>toast(e.message)); }
  ...
  // dDAE_2.112: fallback visualizzazione Pulizie
  try{
    if (page === "pulizie"){
...
// ===== dDAE_2.112 — Multi prenotazioni per stesso nome =====
...
// --- FIX dDAE_2.112: renderSpese allineato al backend ---
...
// --- FIX dDAE_2.112: delete reale ospiti ---
...
// --- FIX dDAE_2.112: mostra nome ospite ---
(function(){
  const orig = window.renderOspiti;
  if (!orig) return;
  window.renderOspiti = function(){
