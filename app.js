 ...
 */
const BUILD_VERSION = "dDAE_2.124";
...
// dDAE_2.124 — error overlay: evita blocchi silenziosi su iPhone PWA
...
/* dDAE_2.124 — Tap counters: Adulti / Bambini <10 (tap increment, long press 0.5s = reset) */
...
if (page === "orepulizia") { initOrePuliziaPage().catch(e=>toast(e.message)); }
  ...
  // dDAE_2.124: fallback visualizzazione Pulizie
  try{
    if (page === "pulizie"){
...
// ===== dDAE_2.124 — Multi prenotazioni per stesso nome =====
...
// --- FIX dDAE_2.124: renderSpese allineato al backend ---
...
// --- FIX dDAE_2.124: delete reale ospiti ---
...
// --- FIX dDAE_2.124: mostra nome ospite ---
(function(){
  const orig = window.renderOspiti;
  if (!orig) return;
  window.renderOspiti = function(){
